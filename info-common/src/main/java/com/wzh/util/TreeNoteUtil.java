...
public class TreeNoteUtil {
     ...
     * @return
     */
    public final static List<TreeModel> getFatherNode(List<TreeModel> treesList){
        List<TreeModel> newTrees = new ArrayList<TreeModel>();
        for (TreeModel mt : treesList) {
     ...
     * @return
     */
    private final static List<TreeModel> getChildrenNode(String pId, List<TreeModel> treesList){
        List<TreeModel> newTrees = new ArrayList<TreeModel>();
        for (TreeModel mt : treesList) {
